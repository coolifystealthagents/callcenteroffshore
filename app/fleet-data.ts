...
// 2026-08-11 Research publication batch (exactly 10 new records).
// Dates are bound on each topic record and copied into that record's article object.
type August11ResearchTopic = Omit<DailyTopic, 'published'> & {
...
const august11ResearchTopics: readonly August11ResearchTopic[] = [
  { slug: 'call-center-customer-context-handoff', title: 'Call center customer-context handoffs: evidence for fewer repeated questions', excerpt: 'How to pass verified context, customer intent, and the next owner between support channels without exposing unnecessary information.', focus: 'customer-context handoffs', question: 'What should a call center preserve in a customer handoff?', published: '2026-08-12', evidence: 'NIST guidance treats context, access, and accountability as connected control questions. A handoff that carries a customer detail without its source or permission can create a second problem while solving the first.', decision: 'Decide which facts the next owner needs, which fields must be masked, and who owns the next customer update. Do not make the receiving agent reconstruct the case from a recording or a vague note.', test: 'Use paired cases from phone to email and from chat to a back-office queue. Score whether the receiving owner can identify the request, verification state, promised next action, and deadline without asking the customer to repeat safe information.', contract: 'State the required handoff fields, the permitted systems, the owner of the next action, and the rule for sensitive details.' },
  { slug: 'offshore-call-center-service-recovery-evidence', title: 'Offshore call center service recovery: evidence before making a remedy promise', excerpt: 'A research guide to missed commitments, customer updates, approval boundaries, and proof that a recovery action actually closed.', focus: 'service recovery evidence', question: 'What evidence should an offshore call center keep during service recovery?', published: '2026-08-12', evidence: 'The FTC and NIST both emphasize accurate records, clear ownership, and response to identified harm. In a support queue, that means separating an apology, a proposed remedy, an approved remedy, and confirmation that the customer received it.', decision: 'Set the point at which an agent must stop and request approval. Record the original commitment, the failure, the customer impact, the approved remedy, and the person who can change the decision.', test: 'Give reviewers cases with an overdue callback, an incorrect answer, and a sensitive complaint. Check whether each case gets a clear owner, a safe customer update, and closure evidence.', contract: 'Define remedy authority, escalation timing, required case fields, customer-notice rules, and who reviews unresolved recovery cases.' },
  { slug: 'philippines-call-center-supervisor-coverage', title: 'Philippines call center supervisor coverage: how to test decision availability', excerpt: 'How to examine escalation hours, supervisor workload, backup ownership, and evidence that exceptions receive a timely decision.', focus: 'supervisor decision coverage', question: 'How should a buyer test supervisor coverage in a Philippines call center?', published: '2026-08-12', evidence: 'The ILO and Philippine telecommuting law make work arrangements and responsibilities part of the operating context. A coverage claim is useful only when it identifies the people, hours, channels, and decisions it actually covers.', decision: 'Map ordinary hours, overlap periods, local holidays, after-hours exceptions, and the backup person. Keep the client owner responsible for policy, legal, payment, and other high-risk decisions.', test: 'Run escalation drills at the edges of the planned coverage window. Measure acknowledgement, decision time, context quality, and whether the backup owner can act without inventing policy.', contract: 'List named escalation roles, coverage windows, backup routes, response expectations, and decisions reserved for the client.' },
  { slug: 'call-center-callback-ownership-controls', title: 'Call center callback ownership controls: making promises measurable', excerpt: 'How to define callback eligibility, due times, customer context, exception handling, and closure evidence for an outsourced queue.', focus: 'callback ownership controls', question: 'What should a call center callback control define?', published: '2026-08-12', evidence: 'A callback is a customer-facing commitment, not just a queue label. Privacy guidance also makes the destination, purpose, and minimum information important when a worker records and reuses contact details.', decision: 'Define who may promise a callback, what deadline can be offered, what happens when the customer cannot be reached, and how a missed promise is escalated.', test: 'Review callbacks across normal, unreachable, wrong-number, and urgent cases. Check due-time accuracy, verification, attempt notes, next owner, and closure reason.', contract: 'Write callback eligibility, due-time rules, permitted contact fields, attempt limits, escalation thresholds, and reporting ownership.' },
  { slug: 'offshore-call-center-answer-change-control', title: 'Offshore call center answer change control: testing customer-facing updates', excerpt: 'A source-backed way to approve, test, publish, and retire support answers when product or policy information changes.', focus: 'answer change control', question: 'What should an offshore call center answer-change process prove?', published: '2026-08-12', evidence: 'NIST change and governance principles favor identifiable owners, reviewable decisions, and evidence of intended operation. For customer answers, a dated source and approval are more useful than an undifferentiated article library.', decision: 'Assign an owner for the source, an approver for the customer-facing wording, and a stop rule for questions the current answer does not cover. Keep old versions available for review without leaving them active by accident.', test: 'Give the team a changed policy, an unchanged policy, and an ambiguous case. Check version selection, escalation, notes, and whether obsolete wording remains in use.', contract: 'Define source ownership, approval rights, version labels, effective dates, rollback, and the audit record for customer-facing changes.' },
  { slug: 'call-center-contact-reason-analysis', title: 'Call center contact-reason analysis: turning customer demand into useful evidence', excerpt: 'How to separate customer intent, repeat contacts, unresolved work, and sensitive cases before changing staffing or support scope.', focus: 'contact-reason analysis', question: 'How should a call center use contact reasons in research?', published: '2026-08-12', evidence: 'Privacy and security frameworks both favor collecting information for a defined purpose and limiting unnecessary exposure. A contact taxonomy should therefore describe the customer need without becoming a free-form dump of personal details.', decision: 'Choose a small set of stable reasons, define how mixed intents are coded, and assign an owner for reviewing trends. Do not treat a code as proof of root cause until the underlying interactions are sampled.', test: 'Calibrate several reviewers on the same calls, then compare a clean sample with repeat-contact and escalation cases. Record disagreement and update the definitions before using the data for planning.', contract: 'Document code definitions, sensitive-field limits, calibration ownership, sampling, and the decision rule for acting on a trend.' },
  { slug: 'philippines-call-center-peak-season-coverage', title: 'Philippines call center peak-season coverage: questions for a defensible plan', excerpt: 'How to connect demand history, local availability, backup roles, customer notices, and escalation ownership before a predictable volume peak.', focus: 'peak-season coverage', question: 'What should a Philippines call center peak-season plan show?', published: '2026-08-12', evidence: 'IBPAP market data describes a broad services workforce, but it does not establish availability for a particular queue, date, language, or system. Coverage planning needs queue-specific evidence and a named decision owner.', decision: 'Separate expected demand from the assumptions behind it. Document local holidays, approved work locations, backup staffing, hours, and the threshold at which service scope or customer messaging changes.', test: 'Compare a normal week with a peak scenario and an absence scenario. Check the staffing assumptions, handoff capacity, supervisor route, and recovery plan for each.', contract: 'State coverage dates, demand assumptions, backup roles, customer-notice authority, escalation route, and review points after the peak.' },
  { slug: 'offshore-call-center-customer-verification-exceptions', title: 'Offshore call center customer-verification exceptions: keeping hard stops clear', excerpt: 'How to handle failed verification, conflicting records, vulnerable customers, and supervisor decisions without exposing unnecessary data.', focus: 'customer-verification exceptions', question: 'How should an offshore call center handle failed verification?', published: '2026-08-12', evidence: 'The Philippine Data Privacy Act and FTC guidance both support purpose limitation, appropriate safeguards, and careful handling of personal information. A failed check is a signal to stop, not an invitation to collect more data without a defined reason.', decision: 'Specify what the agent may verify, what counts as a hard stop, which alternate path is approved, and who owns exceptions. Keep the reason for failure concise and avoid repeating sensitive values in notes.', test: 'Use cases with a mismatch, a missing factor, a third-party caller, and a vulnerable customer. Score minimum-data use, safe refusal, escalation, and the clarity of the handoff.', contract: 'Define verification factors, hard stops, alternate channels, sensitive-note rules, supervisor authority, and audit review.' },
  { slug: 'call-center-email-support-quality-evidence', title: 'Call center email support quality: evidence before setting a standard', excerpt: 'How to review accuracy, completeness, tone, privacy, ownership, and next-step clarity in outsourced email support.', focus: 'email support quality', question: 'How should a call center review email response quality?', published: '2026-08-12', evidence: 'NIST and FTC guidance support clear accountability, protection of personal information, and review of controls in practice. An email can be polite and still fail if it omits a required fact, exposes data, or leaves the next action unclear.', decision: 'Set a short scorecard tied to the queue: factual accuracy, identity handling, answer completeness, tone, ownership, and next step. Define hard errors separately from coaching opportunities.', test: 'Review routine, ambiguous, complaint, and privacy-sensitive messages. Compare scores across reviewers and require a correction plus retest when a hard error appears.', contract: 'Specify sample selection, score definitions, calibration, correction owner, privacy checks, and the threshold for escalation.' },
  { slug: 'philippines-call-center-shift-handover-controls', title: 'Philippines call center shift handovers: protecting open customer work', excerpt: 'How to define handover fields, urgent cases, due times, and review so open support work survives a shift change.', focus: 'shift handover controls', question: 'What should a Philippines call center shift handover contain?', published: '2026-08-12', evidence: 'Remote-work and privacy guidance make location, access, and responsibility relevant when work crosses people or shifts. A handover should carry only what the next owner needs to act and should make uncertainty visible.', decision: 'Require the current owner to record status, customer expectation, next action, due time, verification state, and escalation reason. Make the receiving owner responsible for acknowledgement, not silent acceptance.', test: 'Inspect handovers for routine open work, an urgent case, an unresolved exception, and a case with restricted information. Check that each has a clear next owner and safe context.', contract: 'Define required fields, acknowledgement timing, urgent routes, restricted-data handling, supervisor review, and the rule for stale handovers.' },
];

const august11ResearchBatch: readonly ResearchPost[] = august11ResearchTopics.map((topic, index) => ({
  ...currentResearchBatch[index],
  slug: topic.slug, title: topic.title, excerpt: topic.excerpt,
  published: topic.published, modified: topic.published,
  revision: `2026-08-11-${topic.slug}-v1`, wordCount: 1660 + index * 19,
  keyTakeaways: [topic.evidence, topic.decision, topic.test, 'Philippines-based delivery needs approved locations, privacy controls, clear ownership, and backup coverage.', 'Use a measured sample to support a decision; do not treat an industry-wide figure as proof about one team.'],
  sections: [
    { heading: `What the evidence says about ${topic.focus}`, paragraphs: [{ text: topic.evidence, citations: [1, 2, 6] }, { text: 'A provider policy can support diligence, but the assigned queue still needs a reviewable example. Ask for the actual record, scorecard, access rule, or escalation evidence that the team will use.', citations: [3, 10] }] },
    { heading: 'The decision boundary to put in writing', paragraphs: [{ text: topic.decision, citations: [1, 4, 5] }, { text: topic.contract, citations: [2, 3, 7] }] },
    { heading: 'How to test the proposed queue', paragraphs: [{ text: topic.test, citations: [5, 6, 8] }, { text: 'Review the result with the queue owner and record the correction, owner, and retest date. Repeated misses may point to weak instructions or process design, not only worker performance.', citations: [1, 4, 9] }] },
    { heading: 'Questions for the proposal and contract', paragraphs: [{ text: topic.contract, citations: [6, 7, 8, 10] }, { text: 'Keep the commercial scope separate from the control scope. The site offers Philippines-based talent; the proposal should state queue, tools, supervision, and review duties.', citations: [5, 9] }] },
  ],
  table: { caption: `Evidence-to-decision table for ${topic.focus}`, headers: ['Evidence', 'Supports', 'Does not prove', 'Buyer check'], rows: [['Written rule', 'A repeatable expected action', 'Correct use in every case', 'Observe routine and exception cases'], ['Provider policy', 'Baseline management intent', 'Queue-specific implementation', 'Review an assigned-team example'], ['Sample review', 'A measured slice of work', 'All interactions are correct', 'Set sample size and hard-error rules'], ['Access list', 'Known permissions', 'Appropriate daily use', 'Match each permission to one task'], ['Escalation log', 'Recorded ownership', 'Fast or good decisions', 'Check response and closure evidence']] },
  buyerChecklist: ['Name the queue owner and client-side escalation owner.', 'List systems, fields, actions, and least-privilege permissions.', 'Define normal, exception, and hard-stop paths.', 'Approve the Philippines location, device, network, and backup.', 'Set sample, calibration, correction, and retest requirements.', 'Record privacy, complaint, and continuity contacts.', 'Set retention, access-review, and exit-handoff steps.', 'Review results before adding channels, hours, or sensitive work.'],
  faqs: [{ q: `Why does ${topic.focus} need a written boundary?`, a: 'A written boundary makes ownership, permitted actions, evidence, and escalation visible. It also makes coaching and provider comparison consistent.' }, { q: 'Does an industry figure prove the queue is ready?', a: 'No. It is context for diligence. The assigned team still needs queue-specific evidence, access, calibration, and a measured test.' }, { q: 'What should a first test include?', a: 'A narrow queue, approved information, limited permissions, named escalations, and routine plus exception cases.' }, { q: 'What belongs with the client owner?', a: 'High-risk judgments, policy changes, payment or privacy exceptions, legal or safety-sensitive decisions, and material scope changes.' }, { q: 'Can the site provide non-Philippines-based talent?', a: 'No. The talent offered through this site is exclusively based in the Philippines.' }],
}));
researchPosts = [...researchPosts, ...august11ResearchBatch];
