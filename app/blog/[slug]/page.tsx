...
export default async function Post({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const serviceLink = p.slug === 'call-center-refund-escalation-workflow'
    ...
    : p.slug === 'call-center-call-recording-policy'
      ...
      : p.slug === 'after-hours-call-answering-workflow'
        ? { href: '/services/after-hours-answering', label: 'Philippines after-hours answering service guide', prefix: 'For coverage outside your local hours, start with the ', suffix: '. It helps you set the queue, urgent-case route, and next-shift handoff before a Philippines-based team begins taking calls.' }
