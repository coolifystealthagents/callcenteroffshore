  ...
  return (
    <div className="sa-form-card">
      ...
      <form action={endpoint} method="post" onSubmit={submit} id="contactPageForm">
        ...
        <label htmlFor="contact-message">Message<textarea id="contact-message" name="message" rows={4} /></label>
