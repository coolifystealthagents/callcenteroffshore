    ...
    <section className="hero-shell">
      ...
      <div className="hero-grid">
        <div className="hero-copy">
          <p className="eyebrow">Industrial operations</p>
          <h1>Call Center Offshore: a sla dashboard for clearer staffing decisions.</h1>
          <p className="lead">A redesigned offshore call center guide for teams that need offshore call answering, appointment setting, and support coverage. The page now uses a distinct grid-heavy command board layout, industry-specific planning sections, and a conversion path that feels made for this niche.</p>
        ...
        <figure className="hero-media"><img src={site.heroImage || site.serviceImage} alt={site.alt || `${site.brand} planning visual`}/><figcaption>technical grid lines and status tags</figcaption></figure>
      </div>
    </section>
