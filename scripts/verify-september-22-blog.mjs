...
const slugs=[
  'offshore-call-center-rfp-requirements-matrix',
  'call-center-probation-to-production-access',
  'offshore-call-center-multilingual-escalation-design',
  'call-center-invoice-reconciliation-review',
  'offshore-call-center-customer-data-retention-map',
  'call-center-business-hours-change-control',
  'call-center-qa-sampling-bias-check',
  'offshore-call-center-authentication-retry-lockout',
  'call-center-knowledge-source-citation-standard',
  'offshore-call-center-missed-sla-recovery',
  'call-center-client-approval-latency',
  'offshore-call-center-attrition-continuity-plan',
];
